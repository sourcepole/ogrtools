...
#
# Created: Thu Mar 10 17:19:26 2016
...
class Ui_Interlis(object):
    def setupUi(self, Interlis):
        ...
        self.gridLayout.addWidget(self.mDataFileButton, 1, 3, 1, 1)
        self.m = QtGui.QCheckBox(self.transfertab)
        self.m.setChecked(True)
        self.m.setObjectName(_fromUtf8("m"))
        self.gridLayout.addWidget(self.m, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.mDestQgisLayerCheckBox, 5, 2, 1, 1)
        self.cbDbConnections = QtGui.QComboBox(self.transfertab)
        self.cbDbConnections.setObjectName(_fromUtf8("cbDbConnections"))
        self.gridLayout.addWidget(self.cbDbConnections, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.mImdGroupBox, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.mModelAutoLoadCheckBox, 2, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.mDataLineEdit, 1, 1, 1, 2)
        ...
        QtCore.QObject.connect(self.m, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.cbDbConnections.setEnabled)
    ...
    def retranslateUi(self, Interlis):
        ...
        self.m.setText(_translate("Interlis", "QGIS Layer", None))
        self.mDestQgisLayerCheckBox.setText(_translate("Interlis", "Datenbank:", None))
