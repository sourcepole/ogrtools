...
#
# Created: Tue Mar  3 14:45:28 2015
...
class Ui_Interlis(object):
    def setupUi(self, Interlis):
        ...
        self.mCreateIsisMetaButton = QtGui.QPushButton(self.groupBox_2)
        self.mCreateIsisMetaButton.setEnabled(False)
        self.mCreateIsisMetaButton.setObjectName(_fromUtf8("mCreateIsisMetaButton"))
        self.gridLayout_6.addWidget(self.mCreateIsisMetaButton, 1, 0, 1, 1)
        ...
        self.mDataFileButton_2 = QtGui.QPushButton(self.frame_2)
        self.mDataFileButton_2.setObjectName(_fromUtf8("mDataFileButton_2"))
        self.gridLayout_8.addWidget(self.mDataFileButton_2, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Interlis):
        ...
        self.mCreateIsisMetaButton.setText(_translate("Interlis", "IlisMeta erzeugen", None))
        ...
        self.lineEdit_2.setText(_translate("Interlis", "http://interlis.sourcepole.ch/wps", None))
        ...
        self.mDataFileButton_2.setText(_translate("Interlis", "...", None))
        self.lineEdit.setText(_translate("Interlis", "http://models.interlis.ch/", None))
