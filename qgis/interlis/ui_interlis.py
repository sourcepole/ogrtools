...
#
# Created: Tue Jan 21 21:40:57 2014
...
class Ui_Interlis(object):
    def setupUi(self, Interlis):
        ...
        self.label_2 = QtGui.QLabel(self.transfertab)
        ...
        self.chkModelLookup = QtGui.QCheckBox(self.transfertab)
        ...
        self.mSchemaButton = QtGui.QPushButton(self.frame)
        self.mSchemaButton.setEnabled(False)
        self.mSchemaButton.setObjectName(_fromUtf8("mSchemaButton"))
        self.gridLayout_3.addWidget(self.mSchemaButton, 0, 0, 1, 1)
        ...
        Interlis.setTabOrder(self.mModelFileButton, self.mSchemaButton)
        Interlis.setTabOrder(self.mSchemaButton, self.mImportButton)
        ...
        Interlis.setTabOrder(self.mConfigLineEdit, self.chkModelLookup)
        Interlis.setTabOrder(self.chkModelLookup, self.lineEdit)
    ...
    def retranslateUi(self, Interlis):
        ...
        self.label_2.setText(QtGui.QApplication.translate("Interlis", "Modell Lookup", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.mSchemaButton.setText(QtGui.QApplication.translate("Interlis", "Create Schema", None, QtGui.QApplication.UnicodeUTF8))
